  ...
  useEffect(() => {
    async function fetchAnalytics() {
      try {
        ...
        setStats({
          documentsProcessed: approvedSnap.data().count + returnedSnap.data().count,
          avgApprovalHours: approvedSnap.data().count > 0 ? 18 : 0,
          activeUsers: usersSnap.data().count,
          slaCompliance: approvedSnap.data().count > 0 ? 94 : 0,
        });
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400">System analytics and reporting dashboards</p>
      </div>
        ...
        <TabsContent value="documents">
          <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
            ...
            {loading ? (
              ...
              <p className="text-center text-gray-500 py-16">No document data yet</p>
            ) : (
        ...
        <TabsContent value="users">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">
              ...
              <p className="text-gray-500 text-sm py-8 text-center">User activity analytics coming soon — requires audit log aggregation</p>
            </div>
            <div className="rounded-xl border border-gray-800 bg-gray-900 p-6">

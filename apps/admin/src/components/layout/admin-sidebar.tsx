...
import {
  ...
  Bell, Cpu, Database, ChevronRight, Menu, X, LogOut,
} from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <div className="border-t border-gray-800 p-3">
          <Link
            href="/admin/login"
            className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-gray-400 hover:bg-gray-800 hover:text-red-400 transition-colors"
          >
